...
# ATTENTION : si le bundle install ne fonctionne pas (très long), voici la marche à suivre :
# commenter tout sauf les 2 premières lignes (rails et mysal), faire un bundle install, decommenter le reste 
# et refaire un bundle install.
