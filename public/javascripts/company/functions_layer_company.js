...
// initialisation
//---------------------------------------------------------------------------------------------------------
var Tableau_solde_calcul = new Array();
// tableau du solde calcul
var Tableau_solde_calcul_filter = new Array();
// tableau du solde calcul filtres pour l'affichage
var Tableau_facture = new Array();
// tableau du solde calcul
var Tableau_facture_filter = new Array();
// tableau du solde calcul filtres pour l'affichage
var Tableau_gestionnaire = new Array();
// tableau du solde calcul
var Company_detail = new Array();
// detail de la company
var Current_calcul_account = new Array();
// detail du calcul account
var Current_memory_account = new Array();
// detail du memory account

//initialisation de la taille du tableau pour la box content et de la table de correspondance
var taille_tableau_content = 20;
// taille du tableau dans la content box
var content_tableau_connect = new Array();
// connectivité entre l'id de l'element graphique (div) et l'élément du tableau affiché dedans
var content_tableau_current_page = new Array();
// numéro de la page du tableau (sert pour la définition de la connectivité)
var content_tableau_curseur_page = new Array();
// nombre de page du tableau (sert pour l'affichage des page en bas des tableaux)
var content_tableau_liste_page = new Array();
// liste des pages du tableau (sert pour l'affichage des page en bas des tableaux)
var content_tableau_page = new Array('solde_calcul', 'gestionnaire');
// initialisation des pages avec tableau dynamique
var taille_tableau_content_page = new Array()
// taille du tableau dans la content box
...
function affiche_Tableau_content(current_tableau, strname, strnamebdd, stridentificateur) {
    ...
    for (i = content_tableau_curseur_page[strname]; i < content_tableau_curseur_page[strname] + 5; i++) {
        // on affiche un lien vers 5 pages
        if (i < nb_page) {
            strpage = new String();
