...
function lance_calcul(){
    ...
    for(i in Tableau_pieces){
        ...
        Tableau_pieces[i]["assigned"] = parseFloat(Tableau_pieces[i]["assigned"].toString());  
        for(j in table_param){
            if(table_param[j]=="id_material"){
                groups_elem[i]["id_material"]= parseInt(Tableau_pieces[i]["assigned"]);  
            }else{
    ...
    for(i in Tableau_interfaces){
        ...
        table_param = ["id","origine","identificateur","name","type","adj_num_group","id_link","assigned"];
        for(j in table_param){
