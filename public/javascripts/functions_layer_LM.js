...
var NMcurrent_stape = 0;							// étape pour le wizard nouveau model
...
function displayBlack(interupteur) {
	arrLinkId = new Array('bl_1','bl_2','bl_3','bl_4','bl_5','black_footer_top','black_footer');
