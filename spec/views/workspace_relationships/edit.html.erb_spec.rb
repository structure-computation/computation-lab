...
describe "workspace_relationships/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit workspace_relationship form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => workspace_relationship_path(@workspace_relationship), :method => "post" do
